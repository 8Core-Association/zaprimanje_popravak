...
print '<div class="seup-version-display">' . Changelog_Sistem::getVersion() . '</div>';
print '</div>';

// Datum izdanja
print '<div class="seup-form-group">';
print '<label class="seup-label"><i class="fas fa-calendar me-2"></i>Datum izdanja</label>';
print '<div class="seup-version-display">' . Changelog_Sistem::getReleaseDateHuman() . '</div>';
print '</div>';

// Kompatibilnost
print '<div class="seup-form-group">';
print '<label class="seup-label"><i class="fas fa-code me-2"></i>Kompatibilnost</label>';
print '<div class="seup-version-display">Dolibarr 22.0+</div>';
print '</div>';
...
print '<div class="seup-form-group">';
print '<label class="seup-label"><i class="fas fa-building me-2"></i>Kontakt</label>';
