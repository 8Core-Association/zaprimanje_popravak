...
class ObavijestiBell {
    ...
    injectHTML() {
        const rightHeader = document.querySelector('#id-right');
        if (!rightHeader) {
            console.warn('SEUP: Cannot find #id-right header element');
            return;
        }
        ...
        rightHeader.insertAdjacentHTML('afterbegin', bellHTML);
